...
# 6- (0-100) arası eşit aralıklı 5 sayı üretin.
result = np.linspace(0,100,5)

# 7- (10-30) arası tam aralıklı  rastgele 5 sayı üretin.
...
# 17- Üretilen matrisin tüm satırlarındaki ilk elemanları seçiniz.
result = matris[:,0]
...
mtrs = np.random.randint(-50,50,15).reshape(3,5)
ciftler = mtrs[mtrs % 2 == 0]
